...
## Same table with existing pivot tools, vis comes last

- specify vars
- specify aggregation
- specify visual arrangement <- this comes last
...
# Step 1a. Make Functions to make table with the visual specification coming first
