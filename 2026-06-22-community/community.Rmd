...
# Tomorrow - Posit's Data Science Lab - keep it conversational
...
The anatomy of layers like 'geom_point', 'geom_jitter', 'geom_histogram'

Actually all wrap layer() function - **three underlying 'characters'**
that specify the user-facing function
...
<!-- ![toddlers](images/clipboard-1487881172.png) -->
...
'ggplot(penguins) + 
  ...
  ggram:::ggram(code = _, 
                ...
                title = "📓🧪🥽🔬 Posit DS Lab Notebook: 2026 JUL 21 - Extending ggplot2", widths = c(1, .7))
