---
title: "Rehearsal plus monologue... ggplot2 extenders"
...
1.  Articulate value of extension (Why am I even here? Why are *you*
    here?): conversational data viz - being able to write down
    (transcribe!) visual narratives

2.  Gentler introduction to layer extension: Easy Geom Recipes, and Easy
...
3.  Extensions targetted at new audiences:
    ...
    b.  Kids
    c.  Dimention Reduction, ML Crowd...

### What do you want this to help you prepare for?

1.  Tomorrow, Posit Data Science Lab: 'Easy geom recipes', July 21
2.  EAPOST Workshop, July 31-Aug 1
    <https://sites.google.com/view/eaapost/project-overview>
3.  Prepare to Teach, Aug 2nd <https://preparingtoteach.org/>
4.  JSM Boston 2026, 'Past Present and Future of ggplot2 extension'
    <https://ww3.aievolution.com/JSMAnnual2026/index.cfm?do=ev.viewEv&ev=5265>
5.  Posit Conf: Epic graphical poems and conversations
6.  plotnine's Easy Geom Recipes...
7.  Future of the ggplot2 extenders meetup.

------------------------------------------------------------------------

So tomorrow, I'm gonna do Data Science Lab 'easy geom recipes' thing.
We'll talk about types of extensions, and go through a basic Stat
extension.

And in preparing for that (we met up a few weeks ago), I said, 'well
could I just present a few slides talking about why I think ggplot2
extension is important'.

And I was met, reasonably, with a 'No'. Because, 'Eyes glaze
over, people stop listening'. "We don't do monologues at the Data
science Lab. We do conversation." Solid.
...
geom_point: GeomPoint, StatIdentity, position_identity()
...
And monologues sometimes compress
conversations, right?
...
language and conversation... Like with because of LLMS, you may have
been thinking, "like at what point did Natural Language emerge in the
history of the universe, and why does it even work? How did we go from
grunts to meaning" If I utter 'belly button' does that conjure up in the
...
Language is insanely, mindbogglingly powerful.

Conversation is insanely, mindbogglingly powerful.
...
I love that ggplot2 syntax can be concise, but I am a fan of the fact that 'inconcision' is allowed in that it allows us too record ideas practically verbatim. (Like the Data Science Lab conversations transcripts!) But not quite as
inconcisely as natural language...
...
![](images/clipboard-3692050783.png)
...
> And aesthetic mapping is right at the hear to data visualization - is it so wrong to want those decisions to get full voice?  - me riffing on Hans
...
![](images/clipboard-914984770.png)
