...
For each day we plot the 95% confidence interval around the mean based on [t-tests](https://github.com/EvaMaeRey/ggxmean/blob/master/R/ttest.R); these are visualized as a red horizontal segment at the base of the histogram.  The intervals are calculated independently by day of the week. 
