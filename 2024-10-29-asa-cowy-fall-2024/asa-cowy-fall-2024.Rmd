...
### Classical new layer creation w/ new Stat ...
...
```{r}
qlayer_qstat_chars <- chunk_code_get("geom_support_express") |> count_chars()
...
data.frame(wt = c(compute_chars, stat_chars + layer_chars, compute_chars, qlayer_qstat_chars),
           ...
           strategy = c("classic", "classic", "w/ statexpress", "w/ statexpress")) |>
  ggplot() + 
