...
### With your new geom\_\* function, calculation is done under the hood by the ggplot2 system; with these geom\_\* functions, you can write graphical poems with concise new language you've tailored for yourself! 
...
--
Wrap the necessary computation into a function that your target geom_*() function will perform. Try it out.

--

**Step 2. Define a new Stat.** 
--
ggproto objects allow your extension  to work together with base ggplot2 functions!  You'll use the computation function from step 1 to help define it. TryTrTrye

--

**Step 3. Define a user-facing geom\_\* function.** 
--
You're ready to write your function.  You will incorporate the ggproto from step 2.  Test/Enjoy!
