...
Using ggplot2 has been compared to writing 'graphical poems'.
<!-- and a system that lets us 'speak our plot into existence'.  -->
But sometimes we don't have the vocabulary to express ourselves in a fluent way; we may feel tounge-tied.  The ggplot2 extension system allows us to build new vocabulary.  
