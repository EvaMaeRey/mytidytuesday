...
knitr::opts_chunk$set(echo = TRUE, dpi = 300, dev = "ragg_png", fig.width = 8, warning = F, message = F, echo = F)
...
ggram::ggram(code = _, title = "Are Dolphins Doris and Buzz cooperating?🐬🐬🐟🪣", subtitle = "Example and data from 'Introduction to Statistical Investigations' curriculum")
