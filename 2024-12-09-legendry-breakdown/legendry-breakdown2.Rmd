...
library(legendry)
ggplot(data = mpg) +
  aes(x = displ, y = hwy, colour = hwy) +
  geom_jitter() +
  labs(x = "Engine displacement") +
  labs(y = "Highway miles per gallon") +
  labs(col = "Highway miles\nper gallon") +
  theme(axis.line = element_line()) + 
  scale_colour_viridis_c(limits = c(NA, 30), guide = "colbar") +
  guides(x = guide_axis_base(bidi = TRUE)) + 
  guides(y = guide_axis_stack("axis", efficient_bracket)) + 
