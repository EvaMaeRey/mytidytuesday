...
# Background: stats instructors gotta talk about residuals and the model predictions for model observations

Status quo options for doing that in ggplot2

- describe and move on... "image a line that drops down from the observation to the model line"
- precalculate and plot 
- model by model ggplot2 extension... ggols and ggxmean

Also note...

- base plot methods
- other efforts like residpanel https://cran.r-project.org/web/packages/ggResidpanel/vignettes/introduction.html

# Review of existing smooth ggplot2 capabilities
