...
theme_grey <- function(base_size = 11, base_family = "",
  ...
  t <- theme(
    ...
    axis.line.x =        NULL,
    axis.line.y =        NULL,
    axis.text =          element_text(size = rel(0.8), colour = ggplot2:::col_mix(ink, paper, 0.305)),
    ...
    axis.text.r =        element_text(margin = margin(l = 0.8 * half_line / 2, r = 0.8 * half_line / 2),
                                      hjust = 0.5),
    axis.ticks =         element_line(colour = ggplot2:::col_mix(ink, paper, 0.2)),
    ...
    panel.background =   element_rect(fill = ggplot2:::col_mix(ink, paper, 0.925), colour = NA),
    ...
    strip.background =   element_rect(fill = ggplot2:::col_mix(ink, paper, 0.854), colour = NA),
    strip.clip =         "on",
    strip.text =         element_text(
                           colour = ggplot2:::col_mix(ink, paper, 0.105),
                           size = rel(0.8),
...
theme_bw <- function(base_size = 11, base_family = "",
  ...
  theme_grey(
    ...
    theme(
      ...
      panel.border     = element_rect(colour = ggplot2:::col_mix(ink, paper, 0.2)),
      # make gridlines dark, same contrast with white as in theme_grey
      panel.grid = element_line(colour = ggplot2:::col_mix(ink, paper, 0.925)),
      panel.grid.minor = element_line(linewidth = rel(0.5)),
      # contour strips to match panel contour
      strip.background = element_rect(
        fill   = ggplot2:::col_mix(ink, paper, 0.851),
        colour = ggplot2:::col_mix(ink, paper, 0.2)
      ),
...
theme_light <- function(base_size = 11, base_family = "",
  ...
  theme_grey(
    ...
    theme(
      ...
      panel.background = element_rect(fill = paper, colour = NA),
      panel.border     = element_rect(colour = ggplot2:::col_mix(ink, paper, 0.705), linewidth = rel(1)),
      # light grey, thinner gridlines
      # => make them slightly darker to keep acceptable contrast
      panel.grid       = element_line(colour = ggplot2:::col_mix(ink, paper, 0.871)),
      panel.grid.major = element_line(linewidth = rel(0.5)),
      panel.grid.minor = element_line(linewidth = rel(0.25)),

      # match axes ticks thickness to gridlines and colour to panel border
      axis.ticks       = element_line(colour = ggplot2:::col_mix(ink, paper, 0.705), linewidth = rel(0.5)),

      # dark strips with light text (inverse contrast compared to theme_grey)
      strip.background = element_rect(fill = ggplot2:::col_mix(ink, paper, 0.705), colour = NA),
      strip.text       = element_text(
                           colour = paper,
                           size = rel(0.8),
                           margin = margin_auto(0.8 * half_line)
...
theme_dark <- function(base_size = 11, base_family = "",
  ...
  theme_grey(
    ...
    theme(
      # dark panel
      panel.background = element_rect(fill = ggplot2:::col_mix(ink, paper, 0.5), colour = NA),
      ...
      panel.grid       = element_line(colour = ggplot2:::col_mix(ink, paper, 0.42)),
      panel.grid.major = element_line(linewidth = rel(0.5)),
      panel.grid.minor = element_line(linewidth = rel(0.25)),

      # match axes ticks thickness to gridlines
      axis.ticks       = element_line(colour = ggplot2:::col_mix(ink, paper, 0.2), linewidth = rel(0.5)),

      # dark strips with light text (inverse contrast compared to theme_grey)
      strip.background = element_rect(fill = ggplot2:::col_mix(ink, paper, 0.15), colour = NA),
      strip.text       = element_text(
                           colour = ggplot2:::col_mix(ink, paper, 0.9),
                           size = rel(0.8),
                           margin = margin_auto(0.8 * half_line)
                         ),
...
theme_void <- function(base_size = 11, base_family = "",
                       ...
                       base_line_size = base_size / 22,
                       base_rect_size = base_size / 22,
                       ink = "black", paper = alpha("black", 0), accent = "#3366FF") {
  half_line <- base_size / 2
...
p + theme_gray(paper = "darkseagreen4", ink = alpha("lightyellow", .6), accent = alpha("coral", .6))

p + theme_minimal(paper = "darkseagreen4", ink = alpha("lightyellow", .6), accent = alpha("coral", .6))

p + theme_classic(paper = "darkseagreen4", ink = alpha("lightyellow", .6), accent = alpha("coral", .6))


p + theme_void()

p + theme_void()
p + theme_void(paper = "darkseagreen4", 
               ink = alpha("lightyellow", .6), 
               accent = alpha("coral", .6))
