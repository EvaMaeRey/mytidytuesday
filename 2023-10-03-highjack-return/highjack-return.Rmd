...
knitr::opts_chunk$set(fig.width = 10, fig.height = 7, message = FALSE, 
...
`r chunk_reveal("start12", widths = c(2,3), break_type = 1, title = "# first panel times 100")`
...
`r chunk_reveal("start3", widths = c(2,3), break_type = 1, title = "# special highlighting for panel 2")`
