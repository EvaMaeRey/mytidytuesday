...
mammoth_df |> #<<
  ...
  aes(x = V1, y = V2) + 
  geom_confetti() ' |>
  ggram::ggram(code = _, widths = c(.7,1), "Meet 🦣, Smithsonian Mammoth and ML/AI muse!\n She was 3D scanned, downsampled to 10000 observations, with two dimentions presented colorfully here with geom_confetti 🎉🎊", #subtitle = "The now-canonical mammoth dataset can be a fun and intuitive first-taste when exploring dimension reduction techniques,\nfor going from still-familiar 3 dimentional data to the lower-dim representations.",
