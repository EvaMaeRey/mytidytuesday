...
## .small[By creating new points of entry to extension for ggplot2 super-users]
...
## Using 'step 0' to establish baseline knowledge
## multiple examples using same strategy to let patterns sink in
## 
...
## Writing responsible New workshop: ggtedious
