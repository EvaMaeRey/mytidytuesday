...
* June's thesis: users can use ggplot2 more powerfully and dynamically on the *user side* with greater knowledge of delayed aesthetic evaluation? ggtrace serves to help 'crack open ggplot2 internals' to help w/ current knowledge gap about computational that's already taking place and which are available'
