---
title: "ggplot2 extenders meetup"
...
#### .small[Evangeline 'Gina' Reynolds \| 2025-08-26 \| Posit Conf, Image credit: Silas Baisch, Upsplash]
...
<!-- Who are the authors of the extension packages that you may know -->

<img src="images/clipboard-4242710445.png" width="125%" alt="Alt text" />


---
class: center
<!-- # But, actually I'm here to advertise a ggplot2 extension meetup/club/working group… -->
...
<img src="images/clipboard-527321121.png" width="65%" alt="Alt text" />
...
### Co-founded w/ June Choe and myself

--

### benefits from early and continued involvement of Teun van den Brand, current maintainer of ggplot2
...
<img src="images/clipboard-836013170.png" width="65%" alt="Alt text" />
...
## And since spring 2024, our between-meeting discussions has also been an exciting space to exchange ideas about extension strategies and design choices!
...
### - more than 1000 contributionscontact 

---

# Part II.  How to become one? 

# bit.ly/ggplot2extenders

---

... But, why join us? Why be interest in ggplot2 extension at all?


---

<!-- For this question I will just try to get bring you along with personal story... -->

<!-- So we are trying to teach my son Spanish.  He's been in an immersion class, and we do books and sometimes speak Spanish at home. -->
...
<!-- You know what his number 1 phrase is? -->
...
And I guess I'm actually pretty sympathetic to this sentiment.  Because actually I see a lot of parallels between what he's saying --- tell me in my first language--- and what has me so fixated on data viz, ggplot2 and ggplot2 extension.  
...
Instead of saying 'Dime en Inglés' I might say 'Tell me in pictures'.  Tell me in visual language - cause isn't that really our 'first' language. 

Visual information has been informative since day one for most people, and it continues to be a superhighway throughout our lives.  It's 'preattentively processed' so we don't need to expend effort or focus to see patterns, outliers, distributions.

It's effortless, no-friction communication.  

<!-- So I'm happy if someone sits me down and explains things in s -->
<!-- A lot of us who feel compelled to visualize our data and fixate on figures in reports or papers are 'Tell me in pictures' people. -->


But you know, just going back to Spanish v. English, even though just using English might be the easy choice, we just can't give up on Spanish because... 
...
Like English is a disaster... And Spanish is a delight.  Say it, write it down, read it back. It sounds just the way you right it.  Everyone deserves to have a great spelling experience!  

<!-- Express yourself without worrying, hmm I'm not sure if this is spelled right.  You have to go down some rabbit hole on the origin of the word to know how to correctly spell a word. -->


---

And ggplot2 is kind of like this... It let's you write down your plot in such an intuitve way.  
...
# 'I just want to spell my plot how it sounds.' (paraphrase)
...
And so much of the time ggplot2 just nails it... 
...
`r chunk_reveal("scatter0", title = "## easy to write, easy to read ggplot2...", widths = c(2,3))`

```{r scatter0, include = F}
gapminder_2002 |>
  ggplot() +
  aes(x = gdpPercap) +
  aes(y = lifeExp) +
...
> ## the Grammar of Graphics [is] easy because you've just got all these...
...
class: inverse, bottom
background-image: url(https://images.unsplash.com/photo-1517093911940-08cb5b3952e7?q=80&w=444&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
background-size: cover

---

And ggplot2 extension helps you keep thing easy and stacatto.
...
```{r}
geom_residual_springs <- ggsprings:::geom_residual_springs
...
<!-- class: inverse, bottom -->
<!-- background-image: url(images/frueling_ubers_jahr_articulation.png) -->
<!-- background-size: contain -->

<!-- --- -->

<!-- [00:00-00:04 intro](https://youtu.be/ytqXCO3-lOs?si=rF8znHifImsacwXo&t=1) -->
...
class: inverse, bottom
background-image: url(https://images.unsplash.com/photo-1742531616501-3fdd94e5a435?q=80&w=858&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
background-size: cover
...
<!-- > ### 'ggplot2 [is] the best thing ever.' Dewey Dunningham -->

<!-- -- -->

<!-- > ### The plot-element articulation lets you 'ggplot2 let's you speak your plots into existence.' -- Thomas Lin Pedersen -->


<!-- > ### Unfettered conversations with your data.  (Visual information is processed 'preattentively' - seeing patterns, ..., is effortless) -->
...
ggplot(airquality) +  #BREAK
  ...
  facet_grid(rows = vars(Month)) + #BREAK
  geom_vline(data = 
               airquality_by_month,
             aes(xintercept =
               Ozone_mean))  #BREAK
...
`r chunk_reveal("cond_means_hard", break_type = "user")`
...
![](images/arch-in-square.png)


---

![](images/why_so_loud.jpg)

---

# Part II How to become one...? 

A. Lots of failure. Alone. 
B. More guided... 
...
# This plot composition is so *staccato*!
...
# - 'I have to have the results in 10 minutes, and then I need to start working on 5 other reports' Business Analyst
...
<!-- ### - This doesn't feel like the effervecent ggplot2 ... 😞  -->

<!-- -- -->

<!-- ### - I actually have to really focus/think to write/read this plot composition...  ️😖 -->
...
### - ggplot2 4.0.0 release party, Friday Oct 3rd 💿
