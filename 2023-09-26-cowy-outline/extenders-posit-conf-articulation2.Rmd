...
<img src="images/clipboard-527321121.png" width="45%" alt="Alt text" />
...
# Part 0. Why ggplot2 and why extension?

--

# Part 2. How to become an extender? (pathways...)
...
`r chunk_reveal("scatter", title = "## effervecent ggplot2...", widths = c(2,3))`
...
![](images/semicircle-in-square.png)
...
<!-- ### - Supported by Posit since March...  -->
