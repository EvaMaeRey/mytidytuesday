...
# Education: ‘Easy geom_*() recipes’… aimed at beginners (ggplot2 users).  https://evamaerey.github.io/easy-geom-recipes/
...
--
But we have a support group for when things get harder (ggplot2 extenders)… (and more educational resources in the works)
