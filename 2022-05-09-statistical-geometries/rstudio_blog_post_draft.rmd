...
Learning the mechanisms needed to build ggxmean functions took me a chunk of time - about six months. Once worked out, though, I found that mechanisms quite fruitful, writing about 25 geom_* functions in ggxmean that I think worthy of a geom in that they are distinct concepts in our statistical vocabulary.  

Working with Morgan and Madison gave me another chance to think about this particular extension mechanism, and how to make it accessible to new learners.  Morgan and Madison are superstar students in the West Point math department, but relative newcomers to R and ggplot2.
...
This can may be overwhelming to those interested in ggplot extension.  ##The status quo for newcomers are directed to create a new theme as the go-to starting point for getting started with extension.  

In my experience, though, using a new theme pales to the thrill of seeing a new geom, doing a bunch of computational work in the background, (nerd alert!!) used in a ggplot build.  I think the same  will be true for a lot of more math and statistically minded folks!  
