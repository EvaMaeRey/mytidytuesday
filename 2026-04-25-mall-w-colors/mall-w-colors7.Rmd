...
knitr::opts_chunk$set(echo = TRUE, dpi = 400, dev = "ragg_png", warning = F, message = F)
...
'tribble(~item,  ~times, 
  ...
  scale
  aes(fill = I(color))' |> 
ggram::ggram(code = _, title = "🧪🧫🔬HaveLLM assisted semantic color encoding using {mall}!🎨🎉", subtitle = "Colors selected with mall::llm_vec_classify() which translated \n from an animal to a specific color among 12 options in a pallet 👀🤯")
