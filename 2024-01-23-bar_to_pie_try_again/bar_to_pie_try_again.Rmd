...
```{r, code = readr::read_lines("https://raw.githubusercontent.com/tidyverse/ggplot2/main/R/geom-bar.R")}
...
```{r, code = readr::read_lines("https://raw.githubusercontent.com/tidyverse/ggplot2/main/R/stat-count.R")}
