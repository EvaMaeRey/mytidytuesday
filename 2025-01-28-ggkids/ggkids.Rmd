...
ggplot2 is already quite logical and accessible, but may present some challenges for young learners given more limited vocabulary and tolerance for frustration.

1. `ggkids()` is an alias for `ggplot()`.  Either can be used to initialized the plot and set global data. `ggkids` might be prefered if you want to more strongly signal 'we made this just for you, kiddos!'.
