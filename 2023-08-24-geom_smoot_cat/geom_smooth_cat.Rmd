...
## almost surely new to you (and probably more interesting): predicting at observed values of x

xseq is not advertized, but possibly of interst.. https://ggplot2.tidyverse.org/reference/geom_smooth.html
...
# Proposal: Can we make this available in a bit 'smoother' way?  And also explicitly visualize error (segments)
