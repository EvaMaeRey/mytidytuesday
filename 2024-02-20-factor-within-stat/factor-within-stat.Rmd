...
### stats are really flexible and let you compute to different x and y vals

### but when you want a factor scale for positional aesthetics, where the factor is not the original input, I'm not sure what tools to use.
